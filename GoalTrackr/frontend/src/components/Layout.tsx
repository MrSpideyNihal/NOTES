                            ...
                            <div className="flex h-16 justify-between">
                                <div className="flex">
                                    <div className="flex flex-shrink-0 items-center">
                                        <span className="text-xl font-bold text-indigo-600 dark:text-indigo-400">GoalTrackr</span>
                                    </div>
                        ...
                        <Disclosure.Panel className="sm:hidden">
                            <div className="space-y-1 pt-2 pb-3">
                                ...
                                <Disclosure.Button
                                    as="button"
                                    onClick={logout}
                                    className="block w-full text-left border-transparent text-gray-500 hover:bg-gray-50 hover:border-gray-300 hover:text-gray-700 border-l-4 py-2 pl-3 pr-4 text-base font-medium"
                                >
                                    Sign out
                                </Disclosure.Button>
                            </div>
